...
namespace nova {
    ...
    #ifdef __GCC__
    inline typename aligned_array<sample_type, n>::value_type * __attribute__((aligned(64))) * get_samples(aligned_array<sample_type, n> & arg)
    #else
    inline typename aligned_array<sample_type, n>::value_type * get_samples(aligned_array<sample_type, n> & arg)
    #endif
    {
        return arg.begin();
    }
    ...
    template <typename sample_type, std::size_t n>
    #ifdef __GCC__
    inline const  __attribute__((aligned(64))) * get_samples(aligned_array<sample_type, n> const & arg)
    #else
