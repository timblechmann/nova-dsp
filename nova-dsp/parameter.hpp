...
//  Copyright (C) 2007, 2010 Tim Blechmann
//
...
#ifndef NOVA_DSP_PARAMETER_HPP
#define NOVA_DSP_PARAMETER_HPP
...
public:
    ...
    operator data_type(void) const
    {
        const data_type interpolation (detail::decay_factor(data_type(delay_time), data_type(decat_time)));
